...
export default function ContactHero() {
    return (
        <section className="relative overflow-hidden px-6 pt-36 pb-24 md:px-16 md:pt-40 md:pb-28 lg:px-24 2xl:px-32">
            ...
            <div className="relative z-10 text-center mx-auto max-w-7xl 2xl:max-w-400">
                <motion.p
                ...
                <motion.h1
                    ...
                    className="mx-auto max-w-5xl xl:max-w-6xl text-4xl font-light leading-tight tracking-tight text-white md:text-6xl lg:text-7xl"
                >
                ...
                <motion.p
                    ...
                    className="mx-auto mt-8 max-w-3xl text-base leading-8 text-white/75 md:text-lg md:leading-9"
                >
                ...
                <div className="mx-auto mt-10 h-px w-48 bg-linear-to-r from-[#ffc400] to-transparent" />
            </div>
        </section>
    );
}
